...
export const metadata = {
  ...
  description:
    "Simple, transparent pricing for professional websites. Starter from $299. Business, Premium, and Enterprise plans available. Book a free strategy call.",
  openGraph: {
    title: "Pricing | GrowthPilot Website Packages",
    description: "Simple, transparent pricing for professional websites. Starter from $299.",
    type: "website",
    locale: "en_IN",
  },
};
