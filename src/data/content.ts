...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    results: [
      ...
      { metric: "OTA Commission Savings", value: "$3,000/year" },
...
export const testimonials = [
  ...
  {
    quote:
      "We've saved over $3,000 in OTA commissions in the first year alone. The direct booking system GrowthPilot built is a game-changer for our resort.",
    name: "Anita Fernandes",
    role: "Resort Owner, Goa",
    rating: 5,
  },
...
export const referralProgram = {
  ...
  rewards: [
    {
      title: "Cash Rewards",
      description: "Earn $24-60 for every successful referral",
      icon: "IndianRupee",
    },
    {
